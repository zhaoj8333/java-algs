...
class WeighedQuickUnionWithPathHalvingImplTest {

    @Test
    void testVillage() {
        IDisjointSet<Village> uf = new WeighedQuickUnionWithPathHalvingImpl<>(100);
    ...
    @Test
    void testInt() {
        IDisjointSet<Integer> uf = new WeighedQuickUnionWithPathHalvingImpl<>();
        for (int i = 0; i < 10; i++) {
            uf.makeSet(i);
        }

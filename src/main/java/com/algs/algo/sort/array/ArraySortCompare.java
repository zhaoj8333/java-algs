...
public class ArraySortCompare<E extends Comparable<E>> extends StopWatchTask<E> {

    private ArrayCompareAndSwapSort<Integer> sort;

    public ArraySortCompare(Integer[] array, Class<?> sortKlass) {
        ...
        try {
            sort = (ArrayCompareAndSwapSort<Integer>) constructor.newInstance(ArraysUtil.copy(array), cmp);

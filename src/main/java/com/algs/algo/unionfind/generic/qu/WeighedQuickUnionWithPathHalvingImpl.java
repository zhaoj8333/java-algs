...
/**
 * // TODO: 10/18/22
 * Change {@link Map} to {@link com.algs.datastructure.collection.map.IMap}
 */
public class WeighedQuickUnionWithPathHalvingImpl<E> implements IDisjointSet<E> {

    private final Map<E, UFNode<E>> nodes;
    private int count;

    public WeighedQuickUnionWithPathHalvingImpl() {
        this(DefaultValues.DEFAULT_CAPACITY);
    }

    public WeighedQuickUnionWithPathHalvingImpl(int size) {

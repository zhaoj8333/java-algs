...
public final class DrawUtil implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * <tt>DrawUtil.BLACK</tt>, <tt>DrawUtil.BLUE</tt>, <tt>DrawUtil.CYAN</tt>,
     * <tt>DrawUtil.DARK_GRAY</tt>, <tt>DrawUtil.GRAY</tt>, <tt>DrawUtil.GREEN</tt>,
     * <tt>DrawUtil.LIGHT_GRAY</tt>, <tt>DrawUtil.MAGENTA</tt>, <tt>DrawUtil.ORANGE</tt>,
     * <tt>DrawUtil.PINK</tt>, <tt>DrawUtil.RED</tt>, <tt>DrawUtil.WHITE</tt>, and
     *<tt>DrawUtil.YELLOW</tt>.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to DrawUtil)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = DrawUtil.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(DrawUtil.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            DrawUtil.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = DrawUtil.userX(e.getX());
            mouseY = DrawUtil.userY(e.getY());
            mousePressed = true;
        }
    }

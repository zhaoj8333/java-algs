...
// left, root, right
public class InOrderStackIteratorImpl<K extends Comparable<K>, V> extends TreeIterator<K, V> {
    ...
    public InOrderStackIteratorImpl(BstNode<K, V> root, IVisitor visitor) {
        super(visitor);

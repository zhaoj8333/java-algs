...
public class RecursivePostOrderSerializerImpl<K extends Comparable<K>, V> extends BstSerializer<K, V> {

    public RecursivePostOrderSerializerImpl(ITree<K, V> tree) {
        this(tree, null, null);
    }

    public RecursivePostOrderSerializerImpl(ITree<K, V> tree, ValHandler keyHandler, ValHandler valHandler) {
